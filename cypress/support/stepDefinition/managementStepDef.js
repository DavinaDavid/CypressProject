...
const ManagementLoc = require("../../e2e/pageObjects/managementLoc");
...
And("I add new Employee",()=>{
  //  cy.get('button:contains("+ Add New")').click();
    ManagementLoc.ClickAddNewEmployee().click();
})


Then("I provide Employee Data {string}, {string}, {string}, {string}, {string}", (employeeName, employeeEmail, wage, country, employeePhone)=>{
  ManagementLoc.FillEmployeeData(employeeName,employeeEmail,wage,country,employeePhone);
...
And("I search Employee {string}",(searchKeyword)=> {
  ManagementLoc.searchEmployee(searchKeyword);
    });


  Then("I schedule Availability",()=>{
    ManagementLoc.scheduleAvailability();
//     console.log(cy.url);
